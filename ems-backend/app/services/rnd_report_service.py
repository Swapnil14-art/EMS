...
def _resolve_path(path_or_url: str) -> str:
    """
    Convert a URL-relative path (e.g. '/uploads/events/2/rnd_report/photos/abc.jpg')
    to a filesystem path (e.g. 'storage/events/2/rnd_report/photos/abc.jpg').
...
def generate_rnd_report(event: Event, report: EventRndReport) -> str:
    ...
    return f"/uploads/events/{event.id}/rnd_report/generated_rnd_report.docx"
