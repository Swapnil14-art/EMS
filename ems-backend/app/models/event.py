...
class Event(Base):
    ...
    collaborating_clubs = relationship("EventCollaboratingClub", back_populates="event")
    sponsors = relationship("EventSponsor", back_populates="event")
    approvals = relationship("EventApproval", back_populates="event")
    links = relationship("EventLink", back_populates="event")
    documents = relationship("EventDocument", back_populates="event")
    other_docs = relationship("EventOtherDoc", back_populates="event")
    registrations = relationship("EventRegistration", back_populates="event")
    coordinators = relationship("EventCoordinator", back_populates="event")
    edit_history = relationship("EventEditHistory", back_populates="event")
