...
import { Calendar, Edit, CheckCircle2, Users, PlusCircle, Search, MapPin, User } from 'lucide-react';
    ...
    <div className="space-y-6 animate-fade-in">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        {loading ? Array.from({length:4}).map((_,i)=><StatCardSkeleton key={i}/>) : <>
          ...
          <StatCard title="Registrations" value="—" icon={<Users className="w-6 h-6"/>} color="purple"/>
        </>}
      </div>
