...
import {
  ...
  ChevronDown, GraduationCap, Building2, SlidersHorizontal, Home
} from 'lucide-react';
...
const NAV_MAP: Record<string, NavItem[]> = {
  super_admin: [
    ...
    { label: 'Departments', href: '/admin/departments', icon: <Building2 className="w-4.5 h-4.5" /> },
  ...
  associate_dean: [
    ...
    { label: 'Event Calendar', href: '/calendar', icon: <Calendar className="w-4.5 h-4.5" /> },
    { label: 'Browse Events', href: '/events', icon: <Calendar className="w-4.5 h-4.5" /> },
    { label: 'Override Requests', href: '/associate_dean/overrides', icon: <Shield className="w-4.5 h-4.5" /> },
...
export default function SidebarLayout({ children }: SidebarLayoutProps) {
  ...
  return (
    <div className="flex h-screen bg-[var(--card-bg)] overflow-hidden">
      {/* Desktop sidebar */}
      <aside className={cn(
